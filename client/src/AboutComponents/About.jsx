  ...
  return (
        ...
        <div className='h-[250px] md:h-[300px] lg:h-[100px] lg:mb-[450px] mb-40 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[60%,40%]'>
            ...
            <section className=''>
                ...
                <h2 className='font-bold text-xs md:text-xl lg:text-xl ml-3 text-[rgb(34,69,133)] mb-7'>Provide Excellent service</h2>
