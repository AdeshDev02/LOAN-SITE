      ...
      <main className='pg grid justify-center items-center h-[250px] mb-1'>
          ...
          <h2 className='text-blue-400'>Home /</h2><h2 className='text-white'> Our Contact</h2>
           ...
           hover:from-[rgb(155,203,249)] hover:to-[rgb(239,246,255)] hover:border-b-[rgb(41,108,225)] hover:border-b-[2px] transition duration-[0.5s] mb-0'>
              ...
              <p className='text-[rgb(38,106,225)] text-center text-[15px] mt-[20px]'>PHONE</p>

              <p className='text-[rgb(186,141,139)] text-center text-[15px] mt-[20px] mb-[25px]'>(+234) 9031 450 3214</p>
          ...
          <div className='h-fit bg-white rounded-[10px] border-[rgb(214,227,249)] border-solid border-[1px] hover:bg-gradient-to-b
           hover:from-[rgb(155,203,249)] hover:to-[rgb(239,246,255)] hover:border-b-[rgb(41,108,225)] hover:border-b-[2px] transition duration-[0.5s] mb-0'>
              ...
              <p className='text-[rgb(38,106,225)] text-center text-[15px] mt-[20px]'>EMAIL</p>

              <p className='text-[rgb(186,141,139)] text-center text-[15px] mt-[20px] mb-[25px]'>bitxbaseloan23@gmail.com</p>
          ...
          <div className='h-fit bg-white rounded-[10px] border-[rgb(214,227,249)] border-solid border-[1px] hover:bg-gradient-to-b
           hover:from-[rgb(155,203,249)] hover:to-[rgb(239,246,255)] hover:border-b-[rgb(41,108,225)] hover:border-b-[2px] transition duration-[0.5s] mb-0'>
              ...
              <p className='text-[rgb(38,106,225)] text-center  text-[15px] mt-[20px]'>LOCATION</p>

              <p className='text-[rgb(186,141,139)]  text-center text-[15px] mt-[20px] mb-[25px]'>Not yet Found</p>
          ...
          <div className='h-fit bg-white rounded-[10px] border-[rgb(214,227,249)] border-solid border-[1px] hover:bg-gradient-to-b
           hover:from-[rgb(155,203,249)] hover:to-[rgb(239,246,255)] hover:border-b-[rgb(41,108,225)] hover:border-b-[2px] transition duration-[0.5s] mb-0'>
              ...
              <p className='text-[rgb(38,106,225)] text-center text-[15px] mt-[20px]'>FAQ'S</p>

              <p className='text-[rgb(186,141,139)] text-center text-[15px] mt-[20px] mb-[25px]'>Frequently Asked</p>
          ...
          <main className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2'>
            ...
            <div className=''>
                <h1 className='text-[15px] font-bold mb-4 text-blue-500 pt-3 ml-3'>CALL US</h1>
                ...
                <h1 className='text-[15px] font-bold mb-2 text-blue-500 pt-5 ml-3'>CUSTOMER'S SERVICE HOUR</h1>
